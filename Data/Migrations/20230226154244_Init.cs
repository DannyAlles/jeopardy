        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FIO = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Professors_Professors_CreatedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Packages_Professors_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Professors",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionOfPackages", x => new { x.QuestionId, x.PackageId });
                    table.ForeignKey(
                        name: "FK_QuestionOfPackages_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionOfPackages_Questions_QuestionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOfPackages_PackageId",
                table: "QuestionOfPackages",
                column: "PackageId");
